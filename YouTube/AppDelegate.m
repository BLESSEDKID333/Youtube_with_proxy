...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // Load bundled modern root CAs for native (no-VPS) TLS.
    DLog(@"Modern TLS roots loaded: %lu", (unsigned long)[[TLSTrustManager sharedManager] rootCount]);

    // Apply the selected UI style (classic iOS 6 vs iOS 7 flat) before building UI.
